...
<%
    ...
    {
        String sql="update c_exam set ans1=? where question_no=?";
    ...
    {
        String sql="update c_exam set ans2=? where question_no=?";
        PreparedStatement ps=con.prepareStatement(sql);
        ps.setString(1, ans);
        ps.setString(2,no);
        ps.executeUpdate();
    ...
    {
        String sql="update c_exam set ans3=? where question_no=?";
        PreparedStatement ps=con.prepareStatement(sql);
        ps.setString(1, ans);
        ps.setString(2,no);
        ps.executeUpdate();
    ...
    {
        String sql="update c_exam set ans4=? where question_no=?";
        PreparedStatement ps=con.prepareStatement(sql);
        ps.setString(1, ans);
        ps.setString(2,no);
        ps.executeUpdate();
    ...
    {
        String sql="update c_exam set c_ans=? where question_no=?";
        PreparedStatement ps=con.prepareStatement(sql);
        ps.setString(1, ans);
        ps.setString(2,no);
        ps.executeUpdate();
